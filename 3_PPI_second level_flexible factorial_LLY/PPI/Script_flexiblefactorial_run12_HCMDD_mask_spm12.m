...
clc;
%-----------------------------------------------------------------------
matlabbatch{1}.spm.stats.factorial_design.dir = {'D:\2018depression_AVemotion\2020activation_recalculation\result2\work5_PPI_flexiblefac\PPI_ROI2_DLPFC_R\flexiblefactorial_run12_HCMDD_regressall_spm12'};
...
matlabbatch{1}.spm.stats.factorial_design.des.fblock.fac(3).name = 'yinjie';
...
%-------strong_data--------
data1 = 'D:\2018depression_AVemotion\2020activation_recalculation\onelevel2_work5_37V37_ppi_nocontrast_spm8_aftercopy\PPI_ROI2_DLPFC_R';
Runtype1 = 'run1';
Runtype2 = 'run2';
SubjectType1 = 'HC';
...
%以后就可以直接load
%以后就可以直接load
load('D:\2018depression_AVemotion\2020activation_recalculation\result2\work5_PPI_flexiblefac\PPI_ROI2_DLPFC_R\cov_flexiblefactorial.mat');
load('D:\2018depression_AVemotion\2020activation_recalculation\result2\work5_PPI_flexiblefac\PPI_ROI2_DLPFC_R\cov_flexiblefactorial_MD.mat');
...
matlabbatch{1}.spm.stats.factorial_design.masking.em = {'D:\2018depression_AVemotion\2020activation_recalculation\result2\work5_PPI_flexiblefac\PPI_ROI2_DLPFC_R\onesamplet\mask_run12\run12_HCMDD_mask.nii,1'};
